...
namespace Appcopier.Tests
{
    ...
    /// src/Appcopier/Properties/AssemblyInfo.cs as raw text from GitHub and string-parses
    ...
    public class VersionParsingTests
    {
        ...
        private static string RealAssemblyInfoText()
        {
            ...
            Assert.True(
                ...
                "Check the <None Include=\"..\\Appcopier\\Properties\\AssemblyInfo.cs\"> item in Appcopier.Tests.csproj.");
        ...
        public void ParseLatestVersion_OnRealAssemblyInfo_MatchesCompiledAssemblyFileVersion()
        {
            ...
            string compiled = typeof(global::Appcopier.MainForm).Assembly
        ...
        public void ParseLatestVersion_OnRealAssemblyInfo_AgreesWithGetCurrentVersionTostring()
        {
            ...
            string localSide = global::Appcopier.Program.GetCurrentVersionTostring();
        ...
        {
            string version = global::Appcopier.Program.GetCurrentVersionTostring();
        ...
        public void GetCurrentVersionTostring_MatchesAssemblyFileVersionAttribute()
        {
            ...
            string expected = new Version(
                typeof(global::Appcopier.MainForm).Assembly
                    .GetCustomAttribute<AssemblyFileVersionAttribute>()
                    .Version).ToString(3);
        ...
        public void Assembly_DeclaresNoInformationalVersion_SoProductVersionCannotDrift()
        {
            ...
            var informational = typeof(global::Appcopier.MainForm).Assembly
